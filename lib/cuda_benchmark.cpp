/**
 * cuda_benchmark.cpp - CUDA benchmark implementation (simulated fallback)
 *
 ...
 */
CudaBenchmark::Results CudaBenchmark::run_simulated(std::size_t problem_size) {
    Results results{};
 ...
 */
CudaBenchmark::Results CudaBenchmark::run(std::size_t problem_size) {
    if (detect_cuda()) {
 ...
 */
std::string CudaBenchmark::format_results(const Results& results) {
